import type { Project, Task, SavedView, CustomFieldDef, ProjectStatus, TaskPriority, GanttStatusColor } from '../types';
...
export function hydrateProjectFromFrontmatter(
  ...
  return {
    ...
    ganttColor: (['green','orange','red','grey'] as GanttStatusColor[]).includes(frontmatter.ganttColor as GanttStatusColor)
      ? (frontmatter.ganttColor as GanttStatusColor) : undefined,
  };
}
